...
function setupFriendModule(openIMSDK) {
    return {
        ...
        getFriendApplicationListAsApplicant: (opid = v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_friend_application_list_as_applicant(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
        getFriendApplicationListAsRecipient: (opid = v4()) => new Promise((resolve, reject) => {
...
function setupGroupModule(openIMSDK) {
    return {
        ...
        getGroupApplicationListAsRecipient: (opid = v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_group_application_list_as_recipient(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
        getGroupApplicationListAsApplicant: (opid = v4()) => new Promise((resolve, reject) => {
        ...
        getGroupMemberOwnerAndAdmin: (groupID, opid = v4()) => new Promise((resolve, reject) => {
