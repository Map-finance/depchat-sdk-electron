...
(function (NativeEvent) {
    ...
    NativeEvent[NativeEvent["USER_TOKEN_INVALID"] = 57] = "USER_TOKEN_INVALID";
    NativeEvent[NativeEvent["RECV_NEW_INVITATION"] = 58] = "RECV_NEW_INVITATION";
    NativeEvent[NativeEvent["INVITEE_ACCEPTED"] = 59] = "INVITEE_ACCEPTED";
    NativeEvent[NativeEvent["INVITEE_ACCEPTED_BY_OTHER_DEVICE"] = 60] = "INVITEE_ACCEPTED_BY_OTHER_DEVICE";
    NativeEvent[NativeEvent["INVITEE_REJECTED"] = 61] = "INVITEE_REJECTED";
    NativeEvent[NativeEvent["INVITEE_REJECTED_BY_OTHER_DEVICE"] = 62] = "INVITEE_REJECTED_BY_OTHER_DEVICE";
    NativeEvent[NativeEvent["INVITATION_CANCELLED"] = 63] = "INVITATION_CANCELLED";
    NativeEvent[NativeEvent["INVITATION_TIMEOUT"] = 64] = "INVITATION_TIMEOUT";
    NativeEvent[NativeEvent["HANG_UP"] = 65] = "HANG_UP";
    NativeEvent[NativeEvent["ROOM_PARTICIPANT_CONNECTED"] = 66] = "ROOM_PARTICIPANT_CONNECTED";
    NativeEvent[NativeEvent["ROOM_PARTICIPANT_DISCONNECTED"] = 67] = "ROOM_PARTICIPANT_DISCONNECTED";
    NativeEvent[NativeEvent["STREAM_CHANGE"] = 68] = "STREAM_CHANGE";
    NativeEvent[NativeEvent["RECEIVE_CUSTOM_SIGNAL"] = 69] = "RECEIVE_CUSTOM_SIGNAL";
    NativeEvent[NativeEvent["ON_PROGRESS"] = 70] = "ON_PROGRESS";
...
const eventMapping = {
    ...
    [NativeEvent.MSG_DELETED]: wasmClientSdk.CbEvents.UnUsedEvent,
...
function setupFriendModule(openIMSDK) {
    return {
        ...
        getFriendApplicationListAsApplicant: (opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_friend_application_list_as_applicant(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
        getFriendApplicationListAsRecipient: (opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_friend_application_list_as_recipient(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
...
function setupGroupModule(openIMSDK) {
    return {
        ...
        getGroupApplicationListAsRecipient: (opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_group_application_list_as_recipient(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
        getGroupApplicationListAsApplicant: (opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_group_application_list_as_applicant(openIMSDK.baseCallbackWrap(resolve, reject), opid);
        }),
        ...
        getGroupMemberOwnerAndAdmin: (groupID, opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.get_group_member_owner_and_admin(openIMSDK.baseCallbackWrap(resolve, reject), opid, groupID);
        }),
        ...
        changeGroupMute: (params, opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.change_group_mute(openIMSDK.baseCallbackWrap(resolve, reject), opid, params.groupID, params.isMute ? 1 : 0);
        }),
...
function setupConversationModule(openIMSDK) {
    return {
        ...
        markMessagesAsReadByMsgID: (params, opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.mark_messages_as_read_by_msg_id(openIMSDK.baseCallbackWrap(resolve, reject), opid, params.conversationID, JSON.stringify(params.clientMsgIDList));
        }),
...
class OpenIMSDK extends Emitter {
    constructor(libPath, emitProxy, enterprise = false, basertc = false) {
        ...
        this.registerFunc = () => {
            ...
            this.libOpenIMSDK.mark_messages_as_read_by_msg_id = this.lib.func('__stdcall', 'mark_messages_as_read_by_msg_id', 'void', ['baseCallback *', 'str', 'str', 'str']);
            ...
            this.libOpenIMSDK.get_friend_application_list_as_recipient = this.lib.func('__stdcall', 'get_friend_application_list_as_recipient', 'void', ['baseCallback *', 'str']);
            this.libOpenIMSDK.get_friend_application_list_as_applicant = this.lib.func('__stdcall', 'get_friend_application_list_as_applicant', 'void', ['baseCallback *', 'str']);
            ...
            this.libOpenIMSDK.change_group_mute = this.lib.func('__stdcall', 'change_group_mute', 'void', ['baseCallback *', 'str', 'str', 'int']);
            ...
            this.libOpenIMSDK.get_group_member_owner_and_admin = this.lib.func('__stdcall', 'get_group_member_owner_and_admin', 'void', ['baseCallback *', 'str', 'str']);
            ...
            this.libOpenIMSDK.get_group_application_list_as_recipient = this.lib.func('__stdcall', 'get_group_application_list_as_recipient', 'void', ['baseCallback *', 'str']);
            this.libOpenIMSDK.get_group_application_list_as_applicant = this.lib.func('__stdcall', 'get_group_application_list_as_applicant', 'void', ['baseCallback *', 'str']);
            ...
            this.libOpenIMSDK.upload_logs = this.lib.func('__stdcall', 'upload_logs', 'void', ['baseCallback *', 'str', 'int', 'str', 'listenerCallback *']);
        ...
        this.uploadLogs = (params, opid = uuid.v4()) => new Promise((resolve, reject) => {
            this.libOpenIMSDK.upload_logs(this.baseCallbackWrap(resolve, reject), opid, params.line, params.ex || '', this.listenerCallback);
        });
