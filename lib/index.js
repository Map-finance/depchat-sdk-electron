...
function setupConversationModule(openIMSDK) {
    return {
        ...
        markMessagesAsReadByMsgID: (conversationID, clientMsgIDList, opid = uuid.v4()) => new Promise((resolve, reject) => {
            openIMSDK.libOpenIMSDK.mark_messages_as_read_by_msg_id(openIMSDK.baseCallbackWrap(resolve, reject), opid, conversationID, clientMsgIDList);
        }),
