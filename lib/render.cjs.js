...
async function createWasmSDK(wasmConfig) {
    if (!wasmSDK) {
        const { getSDK } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@openim/wasm-client-sdk')); });
...
exports.getWithRenderProcess = getWithRenderProcess;
